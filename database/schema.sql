...
('contact_address', 'Gedung Sekretariat PAFI Balikpapan'),
('contact_email', 'pafi.balikpapan@gmail.com'),
('contact_whatsapp', '0811484010'),
('contact_website', 'https://pafi-balikpapan.org'),
('contact_facebook', ''),
('contact_instagram', ''),
('contact_youtube', ''),
('profil_text', '<p>Sejarah dan Profil Singkat PAFI Cabang Balikpapan...</p>'),
('struktur_org_img', ''),
